<template>
	<Listbox v-model="$root.currentTheme">
		...
		<ListboxOptions
			class="absolute top-full right-1/2 z-10 -mr-3 mt-3 w-36 space-y-1 rounded-xl bg-white p-3 text-sm font-medium shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-slate-800 dark:ring-white/5"
		>
