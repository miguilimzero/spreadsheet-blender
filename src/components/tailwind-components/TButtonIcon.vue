...
export default {
	...
	computed: {
		...
		disabledClasses() {
			const disabled = typeof this.$attrs.disabled === 'undefined' ? false : String(this.$attrs.disabled) !== 'false'
			return disabled ? 'cursor-not-allowed opacity-75' : 'cursor-pointer'
		},
		textClasses() {
			return (
				{
